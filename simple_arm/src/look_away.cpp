...
void move_arm_center()
{
    ...
    // request centered join angles [1.57, 1.57]
...
{
    // get the joints current position
...
int main(int argc, char** argv)
{
    ...
    ros::Subscriber sub1 = n.subscribe("/simple_arm/joints_states", 10, joint_states_callback);
    
    // subscribe to rgb_camera/image_raw topic to read the image date inside the look_away_callback
